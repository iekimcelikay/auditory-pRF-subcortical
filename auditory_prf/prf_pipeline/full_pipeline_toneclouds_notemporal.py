"""full_pipeline_toneclouds_notemporal.py
=========================================
pRF pipeline for tone-cloud (Gaussian filterbank) stimuli, without temporal models.

Tone-cloud stimuli use a different naming convention than pure-tone sequences:
    tonecloud{g:02d}_fc{center_hz}hz_dur{D}ms_isi{I}ms_numtones{N}
...
def run_pipeline(
    ...
    LoggingConfigurator(
        ...
        log_filename="pipeline_toneclouds_notemporal.log",
