...
# // [ ] Add an option to define frequency spacing, greenwood, ERB etc.
...
def run_pipeline(
        ...
        run_designs: Optional[list] = None,   # pre-built list of run_designs; overrides n_runs
    ...
    signal_dt_s = 1e-3
    _hrf_params = hrf_params if hrf_params is not None else SUBCORTICAL_PARAMS # NOTE \n:
                                                                                # \n These arenot actually SUBCORTICAL_PARAMS, they are regular cortical params. I haven't changed them.
